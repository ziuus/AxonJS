...
> [!TIP]
> Using React? The `@synapsenodes/react` package simplifies integration with hooks like `useSynapseSignals` and components like `SynapseAvatar`.
...
import { useSynapseSignals } from '@synapsenodes/react';
